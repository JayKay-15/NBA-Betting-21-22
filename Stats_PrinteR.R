...
# cur_date <- "3_15_2021"
# u <- paste0("/Users/Jesse/Documents/MyStuff/NBA Betting/NBA-Betting-21-22/",cur_date,".xlsx")
...
wb <- createWorkbook()
addWorksheet(wb, sheetName = "Away")
addWorksheet(wb, sheetName = "Home")
addWorksheet(wb, sheetName = "Season")


writeData(wb, sheet = "Away", x = away_final_wt)
writeData(wb, sheet = "Home", x = home_final_wt)
writeData(wb, sheet = "Season", x = season_final_wt)
